...
const AgreementForm = () => {
  ...
  const generatePDF = () => {
    ...
    // Rimozione dei tag HTML da agreementText
    const cleanText = agreementText.replace(/<\/?[^>]+(>|$)/g, ""); // Elimina i tag HTML
  
    // Spezza il testo per adattarlo alla larghezza della pagina
    const splitText = doc.splitTextToSize(cleanText, 180);
  
    // Itera e stampa il testo nel PDF, gestendo l'aggiunta di nuove pagine
    splitText.forEach((line) => {
      ...
      verticalOffset += 6; // Spaziatura costante tra le righe
    });
...
`;
    ...
    const agreementText2 = `
      ...
      <div class="agreement-box">
        <h2>1. Artist</h2>
<p>${artistProfessionalName} p/k/a ${artistProfessionalName}</p>

<h2>2. Producer</h2>
<p>${producerProfessionalName} p/k/a ${producerProfessionalName}</p>

<h2>3. Artist Address</h2>
<p>
    Contact Name: ${artistContactName}<br>
    Contact Email: ${artistContactEmail}
</p>

<h2>4. Producer Address</h2>
<p>
    Contact Name: ${producerContactName}<br>
    Contact Email: ${producerContactEmail}
</p>
...
<h2>8. Royalty</h2>
<p>Company shall pay or shall instruct and cause Distributor to pay or otherwise allocate a royalty to Lender in the amount per Master of ${royaltyPercent} of Net Artist Royalties (as defined in the "Producer Royalty Provisions", attached as Schedule 2 and made a part hereof) actually received by Company in connection with exploitations of the Masters hereunder...</p>

<h2>9. Controlled Composition</h2>
<p>The parties acknowledge that the Composition(s) shall be owned and/or controlled in accordance with the ownership interests set forth on Schedule 1...</p>

<h2>10. Ownership of Master(s) / Grant of Rights</h2>
<p>All results and proceeds of the services of Lender, Producer, and/or any third party furnished or engaged solely by Lender or Producer (hereinafter individually and collectively referred to as "Producer Personnel"), including the Master(s) (but excluding the Composition(s) to the extent of Lender's and/or Producer's interest therein...)</p>

<h2>11. Credit</h2>
<p>With respect to the Master(s), Company shall accord, or shall instruct and use reasonable commercial efforts to cause Distributor to provide, credit to Producer as set forth on Schedule 1 on the labels, back cover, and in the liner notes of any record...</p>

<h2>12. Samples</h2>
<p>Lender and Producer will not "sample", "interpolate", or otherwise incorporate into ("Sample," "Sampling") the Master(s) or Composition(s)...</p>

<h2>13. Indemnity / Governing Law / Venue</h2>
<p>(a) Each party hereto agrees to indemnify the other party's designees, licensees & assigns from all damages, liabilities, out-of-pocket costs, losses and expenses...</p>

<h2>14. Miscellaneous</h2>
<ul>
    <li>Company may withhold payments due to Lender pending resolution of any claim related to Lender's foregoing indemnity obligation...</li>
    <li>Neither party will be deemed in breach until written notice and a failure to cure within 30 days...</li>
    <li>This Agreement supersedes all prior agreements and may be signed in any number of counterparts...</li>
</ul>
