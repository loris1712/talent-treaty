...
const AgreementForm = () => {
  ...
  const generatePDF = () => {
    ...
    const cleanText = agreementText.replace(/<\/?[^>]+(>|$)/g, "");
  
    const splitText = doc.splitTextToSize(cleanText, 180);
  
    splitText.forEach((line) => {
      if (verticalOffset > pageHeight - 10) {
        doc.addPage();
        verticalOffset = 10; 
      }
  ...
  const handleInputChangeArtistCompany = (event) => {
    setArtistCompany(event.target.value);
  };

  const handleInputChangeProducerCompany = (event) => {
    setProducerCompany(event.target.value);
  };
  
  const handleInputChangeArtistCompanyName = (event) => {
    setArtistCompanyName(event.target.value);
  };

  const handleInputChangeProducerCompanyName = (event) => {
    setProducerLoanoutCompanyName(event.target.value);
  };
...
`;
  ...
  return (
    <div className="container mx-auto p-4 overflow-y-scroll h-[60vh] bg-white radius-[12px] p-4 agreementForm" style={{borderRadius: '12px'}}>
      ...
      <select name="artistCompany" value={artistCompany} onChange={handleInputChangeArtistCompany}>
      ...
      {artistCompany === 'yes' && (
        <div id="artistCompanyNameInput">
          ...
          <input
            ...
            onChange={handleInputChangeArtistCompanyName}
          />
        </div>
      )}
      ...
      <div>
        ...
        <select name="producerCompany" value={producerCompany} onChange={handleInputChangeProducerCompany}>
          <option value="no">No</option>
          <option value="yes">Yes</option>
        </select>
      </div>
      ...
      {producerCompany === 'yes' && (
        <div id="producerCompanyNameInput">
          ...
          <input
            ...
            onChange={handleInputChangeProducerCompanyName}
          />
        </div>
      )}
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
          ...
          <Tooltip id="q1" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
          ...
          <Tooltip id="q2" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q3" data-tooltip-content="Enter the name the producer is known by in the industry. This can be different from their legal name.

">
            ⓘ
          </span>
          <Tooltip id="q3" style={{width: '50vw'}}/>
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q4" data-tooltip-content="Enter the artist's full legal name as shown on their government ID.">
            ⓘ
          </span>
          <Tooltip id="q4" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q5" data-tooltip-content="Enter the name the artist is known by in the industry. This can be different from their legal name.">
            ⓘ
          </span>
          <Tooltip id="q5" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q6" data-tooltip-content="Provide the address where payments or official notices should be sent to the artist.">
            ⓘ
          </span>
          <Tooltip id="q6" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q7" data-tooltip-content="Enter the name of the person responsible for handling communication for the artist.">
            ⓘ
          </span>
          <Tooltip id="q7" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q8" data-tooltip-content="Provide the email address where the artist can be contacted for this agreement.">
            ⓘ
          </span>
          <Tooltip id="q8" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q9" data-tooltip-content="Provide the address where payments or official notices should be sent to the producer.">
            ⓘ
          </span>
          <Tooltip id="q9" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q10" data-tooltip-content="Enter the name of the person responsible for handling communication for the producer. (ex. Manager)">
            ⓘ
          </span>
          <Tooltip id="q10" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q11" data-tooltip-content="Provide the email address where the producer can be contacted for this agreement.">
            ⓘ
          </span>
          <Tooltip id="q11" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q12" data-tooltip-content="Enter the number of master recordings that will be created under this agreement.">
            ⓘ
          </span>
          <Tooltip id="q12" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q13" data-tooltip-content="Enter the upfront payment made to the producer or artist. Include the currency symbol (e.g., $1000).">
            ⓘ
          </span>
          <Tooltip id="q13" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q14" data-tooltip-content="Enter the percentage of royalties the producer or artist will receive (e.g., 5%).">
            ⓘ
          </span>
          <Tooltip id="q14" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q15" data-tooltip-content="Enter the title of the song or musical composition covered by this agreement.">
            ⓘ
          </span>
          <Tooltip id="q15" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q17" data-tooltip-content="Enter the percentage of publishing rights the artist or producer will receive (e.g., 50%).">
            ⓘ
          </span>
          <Tooltip id="q17" style={{width: '50vw'}} />
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="cursor-pointer text-gray-600" 
                data-tooltip-id="q18" data-tooltip-content="Enter the legal jurisdiction (e.g., country, state) that will govern this contract.
(Give an example if you live in the US but are from canada etc.) ">
            ⓘ
          </span>
          <Tooltip id="q18" style={{width: '50vw'}} />
      </div>
